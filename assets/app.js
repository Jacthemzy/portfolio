...
sr.reveal(".home_content, .aboutimg, .servicecontent, .contact_content", {
  origin: "left",
});

sr.reveal(".home_img, .aboutcontent, .serviceinfo, .contact_form", {
  origin: "right",
});

sr.reveal(
  ".skills_wrapper, .counterwrapper, .portfoliowrapper, .testimonialwrapper, .blogwrapper, .footer_content",
  {
    origin: "bottom",
  }
);